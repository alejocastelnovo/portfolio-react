...
export const HERO_CONTENT = `Licenciado en Desarrollo de Software. 
...
Tengo 22 años.<br /> <br />
Estoy finalizando la Licenciatura en Desarrollo de Software<br /> <br />
...
export const PROJECTS = [
  ...
  },
  {
    ...
    image: project3,
    description:
      "Cambiamos la interfaz de usuario del sistema de gestion de nuestro instituto",
